...
export const API_UPDATE_PASSWORD = "/update_password";
...
export const API_PROJECT_INFO = "/projects/<project_id>/get_info";
...
export const API_GET_PROJECT_CHART_STATUS =
  "/projects/<project_id>/get_chart_status";
export const API_GET_PROJECT_CHART_OVERVIEW =
  "/projects/<project_id>/get_chart_overview";
//admin
